...
print("\033[91mVOTAÇÃO - SEGUNDO TURNO\033[0m")
...
while decisao != 0:
    ...
    decisao = int(input("\033[92mDigite a opção desejada:_\033[0m"))
    ...
    if decisao == 1:
        ...
        while voto != 0:
            ...
            voto = int(input("\033[92mDigite a opção desejada:_\033[0m"))
            if voto!=0:
    ...
    if decisao == 4:
        if listaVotos == []:
            ...
            print('Resultado não apurado!')
        else:
            print("\033[1m-----------------------\033[0m")
            print(f'\033[93mTotal de votos Nulos: {votosNulo}, porcentagem: {(votosNulo/totalVotos)*100:.2f}%\033[0m')
            print(f'\033[94mTotal de votos Blue: {votosBlue}, porcentagem: {(votosBlue/totalVotos)*100:.2f}%\033[0m')
            print(f'\033[91mTotal de votos Red: {votosRed}, porcentagem: {(votosRed/totalVotos)*100:.2f}%\033[0m')
            print(f'\033[92mTotal de votos: {totalVotos}, porcentagem: {(totalVotos/totalVotos)*100:.2f}%\033[0m')
