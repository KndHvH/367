...
def calcAll(lista):
    """
    recebe o input de todas as notas e chama todas as outras funcoes do codigo para realizar os calculos de media e status de cada tipo de avaliacao
